...
def main():
    ...
    if training_args.do_train:
        ...
        map_fn_train = partial(
            ...
            # cache_file_name='/media/hdd/.cache/huggingface/distil-whisper___ami-ihm/ihm/0.0.0/31e251d2598632ba3518f762dacdfe1/cache-a995910a63d07fd2_00000_of_00008.arrow'
        )
        with accelerator.main_process_first():
    ...
    for epoch in range(epochs_trained, num_epochs):
        # TODO: sampling dataset
        vectorized_datasets["train"] = vectorized_datasets["train"].shuffle(training_args.seed)
        # vectorrized_datasets_sampled_train = vectorized_datasets["train"].shuffle(training_args.seed)
